...
_BLOCKED_TRANSCRIPT_WARNING = (
    ...
    "EYT_ACTION_WEBSHARE_PROXY_USERNAME/EYT_ACTION_WEBSHARE_PROXY_PASSWORD "
    "(optional EYT_ACTION_WEBSHARE_PROXY_LOCATIONS, "
    "EYT_ACTION_WEBSHARE_RETRIES_WHEN_BLOCKED) or "
    "EYT_ACTION_PROXY_HTTP_URL/EYT_ACTION_PROXY_HTTPS_URL."
)
